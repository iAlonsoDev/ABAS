...
Public Class R_DetallePlanilla_Usuario


    Private Sub R_DetallePlanilla_Usuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LlenarPlanillas()
    ...
    Private Sub CmdActualizar_Click(sender As Object, e As EventArgs) Handles cmdActualizar.Click
        ...
        Me.detalledeplanilla_usuarioTableAdapter.Fill(Me.PlanillaDataSet.detalledeplanilla_usuario, Fecha1.Value, Fecha2.Value, PlanillaComboBox.Text, ComboBox1.Text)
