Public Class R_45
    ...
    Private Sub R_45_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CmdActualizar_Click(sender As Object, e As EventArgs) Handles cmdActualizar.Click
        ...
        'TODO: esta línea de código carga datos en la tabla 'ABASDataSet.Ausencias' Puede moverla o quitarla según sea necesario.
        Me.AusenciasTableAdapter.Fill(Me.OperacionesDataSet.Ausencias, txtbusqueda.Text, Fecha1.Value, Fecha2.Value)
