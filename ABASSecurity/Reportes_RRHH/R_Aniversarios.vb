Public Class R_Aniversarios
    Private Sub R_Aniversarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        'TODO: esta línea de código carga datos en la tabla 'ABASDataSet.Aniversario' Puede moverla o quitarla según sea necesario.
        Me.AniversarioTableAdapter.Fill(Me.RRHHDataSet.Aniversario, TextBox1.Text)
        Me.ReportViewer1.RefreshReport()
    End Sub
End Class